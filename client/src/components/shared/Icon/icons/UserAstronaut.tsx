...
const UserAstronaut: FC<IIconComponentProps> = ({
  color = 'currentColor',
  width = 24,
  height = 24,
  ...props
  ...
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" width={width} height={height} color={color} fill={color} {...props}>
